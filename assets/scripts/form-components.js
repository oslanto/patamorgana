var FormComponents = function () {
    ...
    var handleSpinners = function () {
        ...
        $('#spinner3').spinner({value:7, min: 7, max: 16});
        $('#spinner4').spinner({value:10, step: 100, min: 10, max: 10000});
    }
    ...
    var handleDateRangePickers = function () {
        ...
        $('#reportrange2').daterangepicker({
                ...
                ranges: {
                    'Hingga Akhir Bulan': [moment(), moment().endOf('month')],
                    'Untuk 3 Bulan': [moment(), moment().add('month', 3).endOf('month')]
                },
                buttonClasses: ['btn'],
                applyClass: 'purple',
                cancelClass: 'default',
                ...
                locale: {
                    ...
                    fromLabel: 'Mulai',
                    toLabel: 'Hingga',
                    customRangeLabel: 'Periode Pilihan',
        ...
        $('#reportrange2 span').html(moment().format('MMMM D, YYYY') + ' - ' + moment().add('days', 29).format('MMMM D, YYYY'));
